...
---
This is the code used to build my personal website and blog. I used the Toha theme as part of the Hugo package to get the framework, and updated the content through CSS, HTML and Javascript. This project is ongoing, and is updated somewhat frequently.


You can find my website at: [joekagumba.com](https://www.joekagumba.com/)
